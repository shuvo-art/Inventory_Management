...
(1, 'john_smith@example.com', '$2y$10$rhXgcuqxup8.un6GzQm1gO5N2eI2/AIcPYGVITg3LEbW9.3LDIlHK', 'John', 'master', 'Active'),
(2, 'donahuber@example.com', '$2y$10$Ex.JTn6Cu7lCHgaJoCBVeu0qer0cFp2X1qTIpPg2qfIkkuj3LjjMK', '0', 'user', 'Active'),
(3, 'roy_hise@example.com', '$2y$10$XlyVI9an5B6rHW3SS9vQpesJssKJxzMQYPbSaR7dnpWjDI5fpxJSS', '0', 'user', 'Active'),
(4, 'peter_goad@example.com', '$2y$10$n1B.FdHNwufTkmzp/pNqc.EiwjB8quQ1tBCEC7nkaldI5pS.et04e', '0', 'user', 'Active'),
(5, 'sarah_thomas@example.com', '$2y$10$s57SErOPlgkIZf1lxzlX3.hMt8LSSKaYig5rusxghDm7LW8RtQc/W', '0', 'user', 'Active'),
(6, 'edna_william@example.com', '$2y$10$mfMXnH.TCmg5tlYRhqjxu.ILly8s9.qsLKOpyxgUl6h1fZt6x/B5C', '0', 'user', 'Active'),
(8, 'john_parks@example.com', '$2y$10$WtsZUxIIz/N4NoIW0Db.pu0VfLWcPs6TyQ8SkpVHLDLGhdNOfALC.', '0', 'user', 'Active'),
(10, 'peter_parker@example.com', '$2y$10$GoQvEZNTWEibo0FPK7h57eA5UsNkXfIdex1deGsW/CFIY8zqxyu2S', '0', 'user', 'Inactive'),
(11, 'rashedcse18@.com', '$2y$10$89MPuoGhFU8StnTkFzARCulxXjNQRlIYm1TMCTS0HfX7tC1eWxyZ6', '0', 'user', 'Active'),
(12, 'rashedcse18@example.com', '$2y$10$09eL3L21VPgnDOPPVUvXVeRLvp2oaPwz..pRV2PH7whXV6pN0ihfK', '0', 'user', 'Active');
